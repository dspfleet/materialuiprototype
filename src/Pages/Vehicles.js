    ...
    return (
        ...
        <Grid container spacing={0} justify = "center" >
            ...
            <Grid item xs={12} md={6} className={classes.gridContentBox}  > 
                ...
                ut labore easdft dolore magna aliqua. Rhoncus dolor purus non enim praesent elementum
                facilisis leo vel. Risus at ultrices mi tempus imperdiet. Semper risus in hendrerit
                gravida rutrum quisque non tellus. Convallis convallis tellus id interdum velit laoreet id
                donec ultrices. Odio morbi quis commodo odio aenean sed adipiscing. Amet nisl suscipit
                adipiscing basdfibendum est ultricies integer quis. Cursus euismod quis viverra nibh cras.
